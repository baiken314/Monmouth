# Bradley Aiken
# perlex5.pl
# Read a roster file and take command line arguments to perform 
# different operations.
#  - used with roster.txt
#  - perl perlex5.pl < roster.txt -help
#   - display help text
#  - perl perlex5.pl < roster.txt -first
#   - sort by first name
#  - perl perlex5.pl < roster.txt -last
#   - sort by last name
#  - perl perlex5.pl < roster.txt -id
#   - sort by id
